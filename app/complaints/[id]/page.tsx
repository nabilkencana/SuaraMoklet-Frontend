...
export default function ComplaintDetailPage() {
          ...
          <main className="flex-grow flex items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="text-center space-y-4 max-w-sm">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-bold text-red-650 hover:text-red-750 transition-colors"
              >
  ...
  if (!mounted || isLoading || !currentComplaint) {
    return (
      <div className="min-h-screen bg-[#FAFAFA] flex text-slate-800">
        ...
        <div className="flex-1 lg:pl-64 flex flex-col min-h-screen">
          <DashboardHeader onToggleSidebar={() => setSidebarOpen(true)} />
          <main className="flex-grow max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6 animate-pulse">
  ...
  const statusInfo = STATUS_CONFIG[currentComplaint.status] || STATUS_CONFIG.OPEN;  return (
    <div className="min-h-screen bg-[#FAFAFA] flex text-slate-800">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-3">
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider flex items-center gap-2 border-b border-slate-100 pb-3">
                  <AlertCircle className="h-4.5 w-4.5 text-red-655" />
              ...
              {currentComplaint.expectedOutput && (
                <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-3">
                  <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider flex items-center gap-2 border-b border-slate-100 pb-3">
                    <HelpCircle className="h-4.5 w-4.5 text-red-655" />
              ...
              {currentComplaint.evidenceUrl && (
                <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-3">
                  <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider flex items-center gap-2 border-b border-slate-100 pb-3">
                    <FileText className="h-4.5 w-4.5 text-red-655" />
