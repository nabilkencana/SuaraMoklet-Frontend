          ...
          {activeTab === "dashboard" ? (
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl border border-[rgba(228,190,186,0.3)] shadow-sm p-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
                  <div className="flex items-center gap-6">
                    <h3 className="font-bold text-slate-900 text-lg tracking-tight">Keluhan Aktif ({filteredComplaints.length})</h3>
            ...
            <div className="space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">Organizational Units</h1>
                      <p className="text-slate-500 text-xs mt-0.5 font-medium">Manage school departments and their assigned personnel.</p>
                    </div>
                          ...
                          <div className="bg-white rounded-3xl border border-[#b61722] shadow-md p-6 flex flex-col justify-between min-h-[580px]">
                            <div className="space-y-6">
                              ...
                              <div className="space-y-3">
                                <span className="block text-[10px] font-black text-slate-400 uppercase tracking-wider">Current PIC</span>
                              ...
                              <div className="space-y-3.5">
                                <div className="flex justify-between items-center">
                                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider">Unit Members ({totalMembers})</span>
                            ...
                            <div className="pt-6 border-t border-slate-100">
                              ...
                              >
                                ...
                                <span>Manage Unit Settings</span>
                              </button>
                            </div>
                            </div>
                          );
            ...
            <div className="space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-slate-500 text-xs mt-0.5 font-medium">Manage roles, units, and access for all platform users.</p>
                    </div>
                      ...
                      <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                          <tr className="text-slate-450 font-bold text-xs uppercase border-b border-slate-100 pb-4">
                            <th className="pb-4 pl-2 font-semibold">User Name</th>
