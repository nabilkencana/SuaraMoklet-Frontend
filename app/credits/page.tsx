  ...
  const creditsList = [
    {
      ...
      description: "Pengembang Utama Antarmuka, Animasi & UI Design System SuaraMoklet",
      ...
      <main className="grow max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="text-center space-y-2 pt-2">
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium tracking-wide uppercase">
            Tim Pengembang &amp; Pembangun Platform SuaraMoklet
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 pt-6 max-w-4xl mx-auto">
          {creditsList.map((item) => (
            ...
            >
              ...
              <div
                className={`w-full aspect-square relative overflow-hidden rounded-2xl shadow-md border border-slate-200/80 ${item.bgClass}`}
              >
                <img
                  src={item.image}
                  alt={item.name}
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 backdrop-blur-[2px]">
                  ...
                  {item.socials.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-10 w-10 rounded-full bg-white text-slate-900 flex items-center justify-center hover:bg-red-650 hover:text-white transition-all shadow-md"
                      aria-label="GitHub"
                    >
                  ...
                  {item.socials.linkedin && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-10 w-10 rounded-full bg-white text-slate-900 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all shadow-md"
                      aria-label="LinkedIn"
                    >
                      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                  ...
                  {item.socials.instagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-10 w-10 rounded-full bg-white text-slate-900 flex items-center justify-center hover:bg-pink-600 hover:text-white transition-all shadow-md"
